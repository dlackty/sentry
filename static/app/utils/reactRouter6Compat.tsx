...
import {DANGEROUS_SET_REACT_ROUTER_6_HISTORY} from './browserHistory';
...
/**
 * When rendered will provide the navigate function as a shimmed browserHistory
 */
export function ProvideGlobalHistory() {
  const navigate = useNavigate();
  useLayoutEffect(() => DANGEROUS_SET_REACT_ROUTER_6_HISTORY(navigate));
