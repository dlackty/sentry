...
CIRCUIT_BREAKER_DEFAULTS = CircuitBreakerConfig(
    ...
    # TODO: No idea what a reasonable value here is
    passthrough_interval=15,  # in sec
...
def _update_error_count(
    ...
    """
    current_count = _get_or_set_error_count(error_count_key, error_limit_window)
    new_count = 0 if reset else current_count + 1
